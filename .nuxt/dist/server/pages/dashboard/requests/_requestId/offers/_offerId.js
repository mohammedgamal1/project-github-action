...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("7832fa1f", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_offerId_vue_vue_type_style_index_0_id_ec26243a_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(598);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_offerId_vue_vue_type_style_index_0_id_ec26243a_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_offerId_vue_vue_type_style_index_0_id_ec26243a_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_offerId_vue_vue_type_style_index_0_id_ec26243a_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_vue_loader_lib_index_js_vue_loader_options_offerId_vue_vue_type_style_index_0_id_ec26243a_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
___CSS_LOADER_EXPORT___.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=Montserrat:wght@500;700;900&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".primary[data-v-ec26243a]{color:#204ecf}.dark-blue[data-v-ec26243a]{color:#0f256e !important}.gray[data-v-ec26243a]{color:#262d3d}.light-gray[data-v-ec26243a]{color:rgba(38,45,61,.64)}.lighter-gray[data-v-ec26243a]{color:rgba(38,45,61,.32)}.black-light[data-v-ec26243a]{color:#111}.btn.btn-outline-secondary[data-v-ec26243a]{color:#333}label[data-v-ec26243a]{text-transform:capitalize}.object-fit-cover[data-v-ec26243a]{object-fit:cover}.object-fit-contain[data-v-ec26243a]{object-fit:contain}.font-14[data-v-ec26243a]{font-size:14px}.font-18[data-v-ec26243a]{font-size:18px}.spacer-5[data-v-ec26243a]{height:5px;width:100%;display:block}.spacer-10[data-v-ec26243a]{height:10px;width:100%;display:block}.spacer-15[data-v-ec26243a]{height:15px;width:100%;display:block}.spacer-20[data-v-ec26243a]{height:20px;width:100%;display:block}.spacer-25[data-v-ec26243a]{height:25px;width:100%;display:block}.spacer-30[data-v-ec26243a]{height:30px;width:100%;display:block}.spacer-40[data-v-ec26243a]{height:40px;width:100%;display:block}.spacer-50[data-v-ec26243a]{height:50px;width:100%;display:block}.spacer-65[data-v-ec26243a]{height:65px;width:100%;display:block}.spacer-100[data-v-ec26243a]{height:100px;width:100%;display:block}.sb-wrapper[data-v-ec26243a]{position:relative}.sb-wrapper .sb-button[data-v-ec26243a]{font:inherit;background:transparent;position:static;border:none;padding:0}.sb-wrapper .sb-button::before .sb-wrapper .sb-button[data-v-ec26243a]{cursor:pointer}.sb-wrapper .sb-button[data-v-ec26243a]::before{content:\"\";display:block;position:absolute;top:0;left:0;width:100%;height:100%}.sb-wrapper .sb-button[data-v-ec26243a]:focus{outline:1px solid}.m-end-2[data-v-ec26243a]{margin-inline-end:10px}.offer-details[data-v-ec26243a]{position:relative;min-height:100vh;background-color:#f7f9fa;padding-bottom:158px}.offer-details .heading[data-v-ec26243a]{background-color:#fff;padding:24px 0;font-weight:bold}.offer-details .heading p[data-v-ec26243a]{font-size:18px;margin:0}.offer-details .status-bar[data-v-ec26243a]{padding:16px 0;font-weight:bold;background-color:#fff9ea;color:#ffc025}.offer-details .status-bar .container[data-v-ec26243a]{text-align:center}.offer-details .status-bar.accepted[data-v-ec26243a]{background-color:#def2e8;color:#00af48}.offer-details .status-bar.rejected[data-v-ec26243a]{background-color:#fee;color:#ff5252}.offer-details .rounds[data-v-ec26243a]{display:flex;justify-content:center;align-items:center;padding:24px 0;background-color:#fff;margin-top:16px;overflow:hidden}.offer-details .rounds .round-card[data-v-ec26243a]{padding:24px 16px;border:1px solid #e3e5e5;border-radius:24px;width:164px;min-width:164px;margin:0 16px}.offer-details .rounds .round-card .text[data-v-ec26243a]{color:#48535b;text-align:center}.offer-details .rounds .round-card .text h3[data-v-ec26243a]{font-weight:bold;text-align:center}.offer-details .rounds .round-card hr[data-v-ec26243a]{margin:16px 0}.offer-details .rounds .round-card.accepted[data-v-ec26243a]{border-color:#00af48}.offer-details .rounds .round-card.rejected[data-v-ec26243a]{border-color:#ff5252}.offer-details .rounds .round-card.pending[data-v-ec26243a],.offer-details .rounds .round-card.negotiating[data-v-ec26243a]{border-color:#ffc025}.offer-details .section[data-v-ec26243a]{background-color:#fff;padding:32px 0;margin-top:18px}.offer-details .section.address .container[data-v-ec26243a]{display:flex;align-items:flex-start}.offer-details .section.address .container .svg-icon[data-v-ec26243a]{margin:2px 16px 0 0}.offer-details .section .images[data-v-ec26243a]{width:100%;height:100%;display:flex;overflow-y:hidden;overflow-x:scroll;padding:8px 0}.offer-details .section .images .image[data-v-ec26243a]{margin-right:12px}.offer-details .section .images .image[data-v-ec26243a]:last-child{margin:0}.offer-details .section .images .image img[data-v-ec26243a]{border-radius:12px}.offer-details .section .number-counter[data-v-ec26243a]{display:flex;justify-content:space-between;align-items:center;padding:16px 0;border-bottom:1px solid #e3e5e5}.offer-details .section .number-counter[data-v-ec26243a]:last-child{border:none}.offer-details .section .number-counter p[data-v-ec26243a]{margin:0;font-weight:600;font-size:16px}.offer-details .section .number-counter .number[data-v-ec26243a]{display:flex;justify-content:center;align-items:center;width:40px;height:40px;border:1px solid #e3e5e5;border-radius:50%}.offer-details .section .chip[data-v-ec26243a]{display:inline-block;padding:8px 12px;background-color:#e6f2ff;color:#0078ff;font-weight:bold;border-radius:32px;margin:0px 12px 12px 0}.offer-details .section .chip[data-v-ec26243a]:last-child{margin:0}.offer-details .actions[data-v-ec26243a]{padding:24px 16px 16px;background-color:#fff;position:fixed;bottom:70px;left:0;width:100%}@media(min-width: 768px){.offer-details .actions[data-v-ec26243a]{bottom:0 !important}}.offer-details .actions .btn[data-v-ec26243a]{padding-top:12px;padding-bottom:12px;border-radius:12px;font-weight:600;border:none}.offer-details .actions .reject-accept[data-v-ec26243a]{display:flex}.offer-details .actions .reject-accept .btn-danger[data-v-ec26243a]{background-color:#fee;color:#ff5252;flex:1;margin-right:14px}.offer-details .actions .reject-accept .btn-primary[data-v-ec26243a]{background-color:#0078ff;flex:3}.offer-details .actions .chat_whatsapp[data-v-ec26243a]{gap:10px}.offer-details .actions .chat_whatsapp .chat-btn[data-v-ec26243a],.offer-details .actions .chat_whatsapp .whatsapp[data-v-ec26243a]{width:100%;gap:5px}.offer-details .actions .chat_whatsapp .whatsapp[data-v-ec26243a]{color:#07b925;border:1px solid #07b925 !important}.offer-details .actions .negotiate-btn[data-v-ec26243a]{width:100%;background-color:#e6f2ff;color:#0078ff;margin-top:14px}@media screen and (max-width: 560px){.offer-details .rounds.mobile-scroll[data-v-ec26243a]{justify-content:flex-start;overflow-x:scroll}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard/requests/_requestId/offers/_offerId.vue?vue&type=template&id=ec26243a&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('b-overlay', {
  ...
  }, [_c('p', [_vm._v(_vm._s(_vm.propertyDetails ? _vm.propertyDetails.name : ''))]), _vm._v(" "), _vm.offerDetails.user ? _c('span', {
    staticClass: "light-gray"
  }, [_vm._v("\n          @ " + _vm._s(_vm.offerDetails.user.full_name) + "\n        ")]) : _vm._e()])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\n            " + _vm._s(_vm.$t('form.PropertyAddress')) + "\n          ")]), _vm._v(" "), (_vm.propertyDetails ? _vm.propertyDetails.city || _vm.propertyDetails.district : '') ? _c('p', [_c('span', {
    staticClass: "font-weight-bold"
  }, [_vm._v("\n              " + _vm._s(_vm.propertyDetails ? _vm.propertyDetails.city : '') + "\n            ")]), _vm._v("\n\n            " + _vm._s(_vm.propertyDetails ? _vm.propertyDetails.district : '') + "\n          ")]) : _c('span', {
    ...
    staticClass: "light-gray font-weight-bold"
  }, [_vm._v("\n            " + _vm._s(_vm.propertyDetails.description_en || 'No description provided') + "\n          ")])])])]), _vm._v(" "), _vm.propertyDetails && _vm.propertyDetails.images ? _c('div', {
    staticClass: "section"
  }, [_c('div', {
    staticClass: "container"
  }, [_c('div', {
  ...
  }, _vm._l(_vm.propertyDetails.images, function (image, index) {
    return _c('div', {
      key: index,
      staticClass: "image"
    }, [_c('img', {
    ...
    staticClass: "number"
  }, [_c('span', [_vm._v(_vm._s(_vm.propertyDetails ? _vm.propertyDetails.no_of_bedroom : 1))])])]), _vm._v(" "), _c('div', {
    staticClass: "number-counter"
  }, [_c('p', [_vm._v("\n              " + _vm._s(_vm.$t('property.bathrooms')) + "\n            ")]), _vm._v(" "), _c('div', {
    staticClass: "number"
  }, [_vm._v("\n              " + _vm._s(_vm.propertyDetails ? _vm.propertyDetails.no_of_bathroom : 1) + "\n            ")])])])])]), _vm._v(" "), _vm.propertyDetails && _vm.propertyDetails.bed_types && _vm.propertyDetails.bed_types.length ? _c('div', {
    staticClass: "section"
  }, [_c('div', {
    staticClass: "container"
  }, [_c('div', {
    ...
    staticClass: "font-size-semi-large font-weight-bold mb-0"
  }, [_vm._v("\n            Beds Availability\n          ")]), _vm._v(" "), _vm._l(_vm.propertyDetails.bed_types, function (bedType, index) {
    return _c('div', {
      key: index,
      staticClass: "number-counter"
    }, [_c('p', [_vm._v("\n              " + _vm._s(bedType.name) + "\n            ")]), _vm._v(" "), _c('div', {
      staticClass: "number"
    }, [_c('span', [_vm._v(_vm._s(bedType.count))])])]);
  })], 2)])]) : _vm._e(), _vm._v(" "), _vm.propertyDetails && _vm.propertyDetails.amenities ? _vm._l(Object.keys(_vm.propertyDetails.amenities), function (amenityType, index) {
    return _c('div', {
      key: index,
      staticClass: "section"
    }, [_c('div', {
    ...
    }, [_vm._v("\n            " + _vm._s(_vm.$t(`form.${amenityType.toLowerCase()}Amenities`)) + "\n          ")]), _vm._v(" "), _vm._l(_vm.propertyDetails.amenities[amenityType], function (amenity) {
      return _c('span', {
        key: amenity.id,
        staticClass: "chip"
      }, [_vm._v("\n            " + _vm._s(amenity.amenity) + "\n          ")]);
    })], 2)]);
  }) : _vm._e(), _vm._v(" "), _vm.offerStatus && _vm.offerStatus !== 'rejected' && _vm.offerStatus !== 'pending' ? _c('div', {
    staticClass: "actions"
  }, [_vm.offerStatus !== 'accepted' && _vm.offerStatus !== 'rejected' ? _c('div', {
  ...
  }, [_vm._v("\n          " + _vm._s(_vm.$t('offer.accept')) + "\n        ")])], 1) : _vm._e(), _vm._v(" "), _vm.offerStatus === 'negotiating' ? _c('b-button', {
    staticClass: "negotiate-btn",
    attrs: {
      "variant": "outline-primary"
    },
    on: {
      "click": function ($event) {
        _vm.negotiationModel = !_vm.negotiationModel;
      }
    }
  }, [_vm._v("\n        " + _vm._s(_vm.$t('offer.counter')) + "\n      ")]) : _vm._e(), _vm._v(" "), _vm.offerStatus === 'accepted' ? _c('div', {
    ...
    attrs: {
      "target": "_blank",
      "href": `https://wa.me/${_vm.offerDetails.landlord_data.mobile}?text=Hello I'm Tenant!`
    }
  }, [_c('img', {
    attrs: {
      "width": "24px",
  ...
  }), _vm._v("\n          Whatsapp\n        ")])], 1) : _vm._e()], 1) : _vm._e(), _vm._v(" "), _c('RejectionReasonsModel', {
    attrs: {
...
// CONCATENATED MODULE: ./pages/dashboard/requests/_requestId/offers/_offerId.vue?vue&type=template&id=ec26243a&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard/requests/_requestId/offers/_offerId.vue?vue&type=script&lang=js&
...
/* harmony default export */ var _offerIdvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    offerStatus() {
      if (this.offerDetails.status_details) return this.offerDetails.status_details.status_tenant;
      return '';
    },
    statusMessage() {
      if (this.offerStatus === 'accepted') return 'Congratulation your offer is accepted. You can Chat Now';else if (this.offerStatus === 'rejected') return 'Offer rejected';else if (this.offerStatus === 'pending') return `Awaiting ${this.offerDetails.user && this.offerDetails.user.full_name} Response`;else if (this.offerStatus === 'negotiating') return `${this.offerDetails.user && this.offerDetails.user.full_name} waiting for your response`;
      return '';
    }
  },
  methods: {
    async updateOffer(type) {
      try {
        const res = await this.$axios.$post(`/user/offers/${this.$route.params.offerId}/interaction`, {
          type
        });
        ...
        setTimeout(() => {
          this.$router.push(`/dashboard/requests/${this.$route.params.requestId}/offers`);
        }, 1000);
      } catch (error) {
    ...
    async sendCounterOffer({
      ...
      try {
        await this.$axios.$post(`/user/offers/${this.$route.params.offerId}/interaction`, {
          type: 'counterOffer',
          price,
          move_in_date,
          note
  ...
  async created() {
    ...
    this.propertyDetails = Data === null || Data === void 0 ? void 0 : Data.property;
    this.requestDetails = await this.$axios.$get(`/requests/${this.$route.params.requestId}`);
    this.requestDetails = this.requestDetails.Data;
    this.loading = false;
  },
  beforeDestroy() {
    this.rejectionModel = false;
...
// CONCATENATED MODULE: ./pages/dashboard/requests/_requestId/offers/_offerId.vue?vue&type=script&lang=js&
 /* harmony default export */ var offers_offerIdvue_type_script_lang_js_ = (_offerIdvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(0);

// CONCATENATED MODULE: ./pages/dashboard/requests/_requestId/offers/_offerId.vue
